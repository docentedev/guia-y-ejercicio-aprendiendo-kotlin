...
// Misma clase abstracta base que en el ejercicio del aula (com.jumbo.dto.Usuario): valida
// nombre, correo y contraseña en el 'init', usando 'require' (equivalente a lanzar
// IllegalArgumentException "a mano" en un constructor de Java, pero como una única expresión).
